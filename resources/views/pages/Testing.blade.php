		...
		<div class="profile-sidebar">
			...
			<div class="portlet light profile-sidebar-portlet portlet-light-bar">
				...
				<div class="row list-separated profile-stat" style="text-align:center;margin: 13px 0 0px -17px;">
					@if($utype == 'ind')
					<div class="col-md-4 col-sm-4 col-xs-3 @if($title == 'connections'){{'active'}}@endif">
					...
					<div class="col-md-4 col-sm-4 col-xs-3 @if($title == 'notify_view'){{'active'}}@endif">
					...
					<div class="col-md-4 col-sm-4 col-xs-3 @if($title == 'mypost'){{'active'}}@endif">
				...
				<div class="row list-separated profile-stat" style="text-align:center;margin: 13px 0 0px -17px;">
					@if($utype == 'ind')
					<div class="col-md-4 col-sm-4 col-xs-3 @if($title == 'friendLink'){{'active'}}@endif">
					...
					<div class="col-md-4 col-sm-4 col-xs-3 @if($title == 'thanks_view'){{'active'}}@endif">
